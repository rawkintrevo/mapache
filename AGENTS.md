...
## Default GitHub Implementation Workflow

For every actionable implementation request in a GitHub-backed repository, use an issue, a separate working branch, a tested commit, and a pull request by default.
