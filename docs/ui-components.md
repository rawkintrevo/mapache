...
| `SessionDetail` | `src/components/sessions/SessionDetail.jsx` | React terminal iframe, capability-gated preview canvas, resize controls, pi-web preview folder controls, and restart controls for the selected session. |
