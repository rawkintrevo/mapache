...
| `Topbar` | `src/components/layout/Topbar.jsx` | Workspace selection, Play/Pause lifecycle control, create/edit/delete, Pi auth and generic environment entry points, refresh, and documentation links. |
...
| `AuthCenterPanel` | `src/components/inspector/AuthCenterPanel.jsx` | Authentication refresh/status feedback and saved generic-key count. |
