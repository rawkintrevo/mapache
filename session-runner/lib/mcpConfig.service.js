...
function codexMcpToml(mcpConfig) {
  ...
  const hasOAuthServer = Object.values(mcpConfig.mcpServers || {}).some((server) => server && server.authMode === "oauth2");
  if (hasOAuthServer) lines.push("mcp_oauth_credentials_store = \"file\"");
