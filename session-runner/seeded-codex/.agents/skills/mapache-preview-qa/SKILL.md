...
description: QA a Mapache codex-web preview with status checks, console logs, screenshots, and Playwright.
---

Use this skill after building a site or starting a preview server in a Mapache codex-web session.
