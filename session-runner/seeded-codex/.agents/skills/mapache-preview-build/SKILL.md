...
description: Build static web output where the Mapache codex-web preview canvas can serve it.
---

Use this skill when building a static website or static frontend bundle in a Mapache codex-web session.
