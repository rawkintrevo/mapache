...
const RESERVED_ENV_NAMES = new Set([
  ...
  "GOOGLE_MCP_ACCOUNT_EMAIL",
  "GOOGLE_MCP_ACCOUNT_NAME",
  "GOOGLE_MCP_CONNECTION_ID",
  "GOOGLE_MCP_CONNECTION_STATUS",
  "GOOGLE_MCP_ENABLED_SERVICES",
  "GOOGLE_MCP_GRANTED_SCOPES",
  "GOOGLE_MCP_TOKEN_REFRESH_URL",
  "GITHUB_AUTOMATION_TOKEN",
  "GITHUB_AUTOMATION_TOKEN_EXPIRES_AT",
  "GITHUB_AUTOMATION_TOKEN_REFRESH_URL",
  ...
  "MAPACHE_AUTOMATION_AGENT_API_URL",
  "MAPACHE_AUTOMATION_AGENT_SOCKET",
  "MAPACHE_AUTOMATION_AGENT_TOKEN_URL",
  "MAPACHE_AUTOMATION_BOOT_INSTANCE_ID",
  "CHROME_CDP_HOST",
  "CHROME_CDP_PORT",
  "CHROME_DISPLAY",
  "CHROME_NOVNC_PORT",
