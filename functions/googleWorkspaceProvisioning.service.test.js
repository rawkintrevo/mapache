...
(async () => {
  ...
  assert.deepStrictEqual(Object.keys(runtime.mcpConfig.mcpServers), ["custom", "google-workspace"]);
  assert.deepStrictEqual(runtime.mcpConfig.mcpServers["google-workspace"], {
