...
const DEFAULT_FUNCTION_REGION = process.env.FUNCTION_REGION || "us-central1";
const globalOptions = {
  maxInstances: 10,
...
const AUTOMATION_AGENT_TOKEN_SECRET = defineSecret("AUTOMATION_AGENT_TOKEN_SECRET");
...
const GOOGLE_OAUTH_ENCRYPTION_KEY = defineSecret("GOOGLE_OAUTH_ENCRYPTION_KEY");
